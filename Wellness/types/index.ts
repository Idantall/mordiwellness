...
export interface AccountWithFilteredCategories extends Account {
    filteredCategories: CategoryDocument[]
}
...
export type TimePeriod = 'day' | 'week' | 'month' | 'year' | '1_month_ago' | '2_months_ago' | '3_months_ago' | 'ever';
